...
& $python3 aws-iot-device-sdk-python-v2\samples\pubsub.py --endpoint a3uf1j30lr99lx-ats.iot.eu-central-1.amazonaws.com --ca_file root-CA.crt --cert dings.cert.pem --key dings.private.key --client_id basicPubSub --topic sdk/test/python --count 0